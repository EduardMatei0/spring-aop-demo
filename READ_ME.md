...
You will need a user admin with password admin, or change credentials in application.properties

### Import POSTMAN Collection

You can import collection from AOP Demo.postman_collection.json
